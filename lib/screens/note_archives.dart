...
class NoteArch extends StatefulWidget {

  @override
  State<StatefulWidget> createState() {
    return NoteArchState();
  }
}

class NoteArchState extends State<NoteArch> {
  int count = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: Colors.lightBlueAccent[100],
        ...
        body: getNoteArchView(),
       );
  }

  ListView getNoteArchView() {
  ...
  void updateListView(){
    ...
    dbfuture.then((database){
      Future<List<Note>> noteListFuture=databaseHelper.getNoteArch();
